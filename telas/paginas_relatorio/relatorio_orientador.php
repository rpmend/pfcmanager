                    ...
                    <div class="col s12">
                        <form method="post">
                            <div class="form-elements">
                                <h3 class="light-blue-text text-darken-3">Orientadores</h3>
                            ...
                            if (isset($_POST["orientador"])) {
                                $resultado_projetos = $servicosProjeto->listarProjetosPorTabelaColunaValorSemestre("orientadores", "orientador_nome", $_POST["orientador"], $_POST["semestre_inicial"], $_POST["semestre_final"]);
