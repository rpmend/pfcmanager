                    ...
                    <div class="col s12">
                        <form method="post">
                            <div class="form-elements">
                                <h3 class="light-blue-text text-darken-3">Cursos</h3>
                            ...
                            if (isset($_POST["curso"])) {
                                $resultado_projetos = $servicosProjeto->listarProjetosPorTabelaColunaValorSemestre("cursos", "curso_nome", $_POST["curso"], $_POST["semestre_inicial"], $_POST["semestre_final"]);
