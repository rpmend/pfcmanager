                    ...
                    <div class="col s12">
                        <form method="post">
                            <div class="form-elements">
                                <h3 class="light-blue-text text-darken-3">Clientes</h3>
                            ...
                            if (isset($_POST["cliente"])) {
                                $resultado_projetos = $servicosProjeto->listarProjetosPorTabelaColunaValorSemestre("clientes", "cliente_nomefantasia", $_POST["cliente"], $_POST["semestre_inicial"], $_POST["semestre_final"]);
