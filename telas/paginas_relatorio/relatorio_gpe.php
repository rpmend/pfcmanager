                    ...
                    <div class="col s12">
                        <form method="post">
                            <div class="form-elements">
                                <h3 class="light-blue-text text-darken-3">GPEs</h3>
                            ...
                            <?php
                            if (isset($_POST["gpe"])) {
                                $resultado_projetos = $servicosProjeto->listarProjetosPorTabelaColunaValorSemestre("gpes", "gpe_nome", $_POST["gpe"], $_POST["semestre_inicial"], $_POST["semestre_final"]);
