                    ...
                    <div class="col s12">
                        <form method="post">
                            <div class="form-elements">
                                <h3 class="light-blue-text text-darken-3">Coordenadores</h3>
                            ...
                            if (isset($_POST["coordenador"])) {
                                $resultado_projetos = $servicosProjeto->listarProjetosPorTabelaColunaValorSemestre("coordenadores", "coordenador_nome", $_POST["coordenador"], $_POST["semestre_inicial"], $_POST["semestre_final"]);
