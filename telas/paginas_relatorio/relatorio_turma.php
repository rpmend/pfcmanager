                    ...
                    <div class="col s12">
                        <form method="post">
                            <div class="form-elements">
                                <h3 class="light-blue-text text-darken-3">Turmas</h3>
                            ...
                            if (isset($_POST["turma"])) {
                                $resultado_projetos = $servicosProjeto->listarProjetosPorTabelaColunaValorSemestre("turmas", "turma_codigo", $_POST["turma"], $_POST["semestre_inicial"], $_POST["semestre_final"]);
