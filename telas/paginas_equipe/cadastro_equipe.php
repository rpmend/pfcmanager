...
?>
    ...
    if (isset($_POST["equipe_gestor"])) {
        if ($servicosEquipe->cadastrarEquipe($_POST["equipe_turma_id"], $_POST["equipe_gestor"], $_POST["equipe_membro1"], $_POST["equipe_membro2"], $_POST["equipe_membro3"], $_POST["equipe_membro4"], $_POST["equipe_membro5"])) {
                    ...
                    <div class="col s12 m6">
                        ...
                        <form action="cadastro_equipe.php" method="post">
                            <div class="form-elements">
                                <h4 class="grey-text text-darken-3" style="margin: 50px 0px 50px 0px">Cadastrar Equipe</h4>
                                <div class="row">
                                    ...
                                    <div class="input-field col s12">
                                        <select name="equipe_turma_id" required="required">
                                            ...
                                            ?>
                                                <option value="<?php echo $linha["turma_id"] ?>"><?php echo $linha["turma_id"] ?> - <?php echo $linha["turma_codigo"] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <!-- Gestor -->
                                    <div class="input-field col s12">
                                        <input name="equipe_gestor" maxlength="45" type="text" class="validate" required>
                                        <label for="equipe_gestor">Gestor</label>
                                    </div>

                                    <!-- Membro 1 -->
                                    <div class="input-field col s12">
                                        <input name="equipe_membro1" maxlength="45" type="text" class="validate" >
                                        <label for="equipe_membro1">Membro 1</label>
                                    </div>

                                    <!-- Membro 2 -->
                                    <div class="input-field col s12">
                                        <input name="equipe_membro2" maxlength="45" type="text" class="validate">
                                        <label for="equipe_membro2">Membro 2</label>
                                    </div>

                                    <!-- Membro 3 -->
                                    <div class="input-field col s12">
                                        <input name="equipe_membro3" maxlength="45" type="text" class="validate">
                                        <label for="equipe_membro3">Membro 3</label>
                                    </div>

                                    <!-- Membro 4 -->
                                    <div class="input-field col s12">
                                        <input name="equipe_membro4" maxlength="45" type="text" class="validate">
                                        <label for="equipe_membro4">Membro 4</label>
                                    </div>

                                    <!-- Membro 5 -->
                                    <div class="input-field col s12">
                                        <input name="equipe_membro5" maxlength="45" type="text" class="validate">
