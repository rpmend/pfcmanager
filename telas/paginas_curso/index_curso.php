  ...
  <body>
    ...
    <main>
      <div class="container">
        <div class="row">
          <form method="POST">
            <h3 class="light-blue-text text-darken-3 page-title">Cursos

              <?php
              // Botão adicionar Área (Apenas Administrador e GPE)
              if (($_SESSION["usuario_perfil"]) == "Administrador" || ($_SESSION["usuario_perfil"]) == "GPE") {
              ?>
                <a title="Adicionar Projeto" href="cadastro_curso.php" class="btn-floating btn-large waves-effect waves-light blue right" style="margin-right: 5%;">
          ...
          <div class="table">
            <table class="striped">
              ...
              <tbody>
                ...
                ?>
                  <?php
                  $resultado = $servicosCurso->pesquisarCurso($_POST["filtro"]);
                  ...
                  ?>
                    <tr>
                      ...
                      ?>
                        <td>
                          <a href="alterar_curso.php?id=<?php echo $linha["curso_id"] ?>"><i class="material-icons">edit</i></a>
                          <a href="deletar_curso.php?id=<?php echo $linha["curso_id"] ?>"><i class="material-icons">delete</i></a>
                        </td>
                      <?php
                      }
                      ?>
