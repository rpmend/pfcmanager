...
?>
    ...
    if (isset($_POST["orientador_nome"])) {
        if ($servicosOrientador->cadastrarOrientador($_POST["orientador_nome"])) {
            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m6">
                        <form action="cadastro_orientador.php" method="post">
                            <div class="form-elements">
                                <h4 class="grey-text text-darken-3" style="margin: 50px 0px 50px 0px">Cadastrar Orientador</h4>
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input name="orientador_nome" maxlength="45" type="text" class="validate" required>
