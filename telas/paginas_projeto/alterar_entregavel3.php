...
?>
    ...
    if (isset($_POST["projeto_entregavel3"])) {
        ...
        if ($servicosProjeto->alterarEntregavel3($_POST["projeto_entregavel3"], $_GET["id"])) {
            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m6">
                        <form action="alterar_entregavel3.php?id=<?php echo $_GET["id"] ?>" method="post">
                            <div class="form-elements">
                                <h3 class="light-blue-text text-darken-3">Alterar Entregável 3</h3>
                                
                                <div class="input-field">
                                    <i class="material-icons prefix black-text">date_range</i>
                                    <input value="<?php echo $linha["projeto_entregavel3"]?>" name="projeto_entregavel3" type="text" class="datepicker">
